...
if sum(sett.Iinoise) + sum(sett.Ienoise) >= 1;
    ...
    % Possible noiseseeds such that correlation of noise <0.02: 40, 45, 46, 73, 80, 116
    % noiseseed = 36 has correlation <0.05
