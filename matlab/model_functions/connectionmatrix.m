...
% sets the local connections according to given probabilities in pl
...
% Computes the mean of the sum of the first dimension (How many outgoing
% connections each neuron has on average)
