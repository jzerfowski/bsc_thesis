...
sgtitle('Oscillation frequency');

if savefigures
    saveas(gcf, [sett.saveloc,'coherence_vs_frequency_correlation', '.', saveformat],saveformat)
end
...
sgtitle('Power at oscillation frequency');
...
wmPhaseP = nanmean(sortpscat(end-2:end));
maxCorP = nanmean(sortyscat(end-2:end));

if savefigures
    saveas(gcf, [sett.saveloc,'coherence_vs_power_correlation', '.', saveformat],saveformat)
end
...
wmPhaseF = mean(sortpscat(end-2:end));
maxCorF = mean(sortyscat(end-2:end));

if savefigures
    saveas(gcf, [sett.saveloc,'coherence_vs_firingrate_correlation', '.', saveformat],saveformat)
end
...
% 
% 
% warning("Due to error getting the Mutual informations by a hack. Check if this is the correct way!")
% MI_freq = nMI_freq(:,:,3);
% MI_fper = nMI_fper(:,:,3);
% MI_power = nMI_power(:,:,3);
% 
% 
% figure; 
% yscat = MI_freq(:,:);
...
% 
% if savefigures
%     saveas(gcf, [sett.saveloc,'coherence_vs_frequency_mutual_information', '.', saveformat],saveformat)
% end
% 
% 
% figure; 
...
% 
% if savefigures
%     saveas(gcf, [sett.saveloc,'coherence_vs_power_mutual_information', '.', saveformat],saveformat)
% end
% 
% figure; 
% yscat = MI_fper(:,:);
...
% 
% if savefigures
%     saveas(gcf, [sett.saveloc,'coherence_vs_firingrate_mutual_information', '.', saveformat],saveformat)
% end
