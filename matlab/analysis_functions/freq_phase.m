...
% AVGFREQ Determines the highest (averaged) frequency in the signal
% Computes an autocorrelation of the signal with itself
% Autocorrelation: Shifting the signal in time and comparing spikes
% Then takes the 10 highest autocorrelation values and computes their
% differences (so xcorr might be highest for 0, 10, 20, ... ->
% Differences are 10, 10, ... Takes the mean of the differences as a
% frequency.
