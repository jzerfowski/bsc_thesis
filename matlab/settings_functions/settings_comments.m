function [sett, para] = settings_comments(savesettings, runnumber)
sett = struct;
para = struct;
...
sett.path = output_path;
sett.savelocdata = [output_path_data, 'run',num2str(runnumber),'/run', num2str(runnumber), '_'];
sett.saveloc = [output_path_figures, 'run',num2str(runnumber),'/run', num2str(runnumber), '_'];

settings_saver(sett, para, savesettings);
