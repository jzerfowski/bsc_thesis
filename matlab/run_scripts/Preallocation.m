...
%% ncomb is the number of possible combinations of two regions (see GetPars.m:110)
...
if reg > 1
    ...
    varNames_standard2  = {'peakcor', 'coh', 'cohi', 'delay', 'phasediff', ...
        'phasediffi', 'phasediff_std', 'Phaselocki_12', 'Phaselocke_12'};
end
...
%     xcorrs(l1steps, l2steps, 2*reg-1) = struct();
%     signal_stats(l1steps, l2steps, reg) = struct();
    ...
    varNames_info2 = {'analysis_info2_max_lag', 'rhos_lags', 'rhos_fper_noise1_reg1', 'rhos_fper_noise1_reg2', 'rhos_fper_noise2_reg1', 'rhos_fper_noise2_reg2', 'rhos_fper_noise1_reg1', 'rhos_fper_reg1_reg2', ...
        'rhos_freq_noise1_reg1', 'rhos_freq_noise1_reg2', 'rhos_freq_noise2_reg1', 'rhos_freq_noise2_reg2', 'rhos_freq_reg1_reg2', ...
        'rhos_power_noise1_reg1', 'rhos_power_noise1_reg2', 'rhos_power_noise2_reg1', 'rhos_power_noise2_reg2', 'rhos_power_reg1_reg2'};
end
